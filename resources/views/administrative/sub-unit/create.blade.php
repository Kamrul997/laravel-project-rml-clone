...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin mt-2 mb-2 ">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{ route('administrative.sub.unit') }}" class="btn btn-primary btn-xs btn-icon-text mb-2 mb-md-0">
        ...
        <div class="col-md-8 grid-margin stretch-card">
            ...
            <div class="card card-Vertical card-default card-md mb-4">
                <div class="card-header">
                    <h6>Sub Unit {{ isset($data) ? 'Edit' : 'Create' }}</h6>
                </div>
                <div class="card-body pb-md-30">
                    <div class="Vertical-form">
                        <form class="forms-sample" action="{{ route('administrative.sub.unit.store') }} " method="POST"
                            ...
                            <div class="form-group {{ $errors->has('zone_id') ? 'has-error' : '' }}">
                                ...
                                <select name="zone_id" id="zone_id" class="form-control js-example-basic-single w-100"
                                    required>
                            ...
                            <div class="form-group {{ $errors->has('area_id') ? 'has-error' : '' }}">
                                ...
                                <select name="area_id" id="area_id" class="form-control js-example-basic-single w-100"
                                    required>
                                    <option value="">Select</option>
                            ...
                            <div class="form-group {{ $errors->has('unit_id') ? 'has-error' : '' }}">
                                ...
                                <select name="unit_id" id="unit_id" class="form-control js-example-basic-single w-100"
                                    required>
                                    <option value="">Select</option>
                                    @foreach ($units as $unit)
                                        <option value="{{ $unit->id }}"
                                            {{ isset($data) && $data->unit_id == $unit->id ? 'selected' : '' }}>
                                            {{ $unit->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="layout-button mt-25">
                                ...
                                <a href="{{ route('administrative.sub.unit') }}">
