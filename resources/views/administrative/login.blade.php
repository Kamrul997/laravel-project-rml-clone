      ...
      <form method="post" action="{{ route('login.post') }}">
         ...
         <div class="edit-profile__body">
            <div class="form-group mb-25">
               ...
               <input type="text" class="form-control" id="employee_id" name="employee_id" placeholder="Employee Id" value="010101">
            </div>
            <div class="form-group mb-15">
               <label for="password">password</label>
               <div class="position-relative">
                  <input id="password" type="password" class="form-control" name="password" value="12345678" placeholder="Password">
