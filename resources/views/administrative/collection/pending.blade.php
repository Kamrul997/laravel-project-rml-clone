...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
  ...
  <div class="d-flex align-items-center flex-wrap text-nowrap">
    ...
    <a href="#" class="btn btn-primary btn-icon-text mb-2 mb-md-0 mr-1 approved-all">
      <i class="btn-icon-prepend" data-feather="check-circle"></i>
      Approved All
    </a>
    @endif
    <a href="{{route('pending_collection_download')}}" class="btn btn-primary btn-icon-text mb-2 mb-md-0">
  ...
  <div class="card-body">
    <div class="row mt-2">
      <div class="col-md-4">
        <div class="input-group mb-2">
          <div class="input-group-prepend">
            <div class="input-group-text search-params text-white" style="background: #727cf5;">Deposit Date Start</div>
          </div>
      ...
      <div class="col-md-4">
        <div class="input-group mb-2">
          <div class="input-group-prepend">
            <div class="input-group-text search-params text-white" style="background-color: #727cf5;">Deposit Date End</div>
          </div>
      ...
      <div class="col-md-4 d-flex justify-content-center align-items-center">
        <div class="input-group mb-2">
          <a href="#" id="btn-search" class="btn btn-primary btn-icon-text mb-2 mb-md-0 submit-btn">
