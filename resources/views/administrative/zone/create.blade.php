...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin mt-2 mb-2 ">
        <div>
            <h4 class="mb-3 mb-md-0">Zone {{ isset($data) ? 'Edit' : 'Create' }}</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{ route('administrative.zone') }}" class="btn btn-primary btn-xs btn-icon-text mb-2 mb-md-0">
            ...
            <div class="card card-Vertical card-default card-md mb-4">
                ...
                <div class="card-body pb-md-30">
                    <div class="Vertical-form">
                        <form class="forms-sample" action="{{ route('administrative.zone.store') }} " method="POST"
                            ...
                            <div class="form-group {{ $errors->has('name') ? 'has-danger' : '' }}">
                                ...
                                @if ($errors->has('name'))
                                    <label id="name-error" class="error mt-2 text-danger" for="name">Please enter a zone
                                        name</label>
                                @endif
                            </div>
                            <div class="layout-button mt-25">
                                ...
                                <a href="{{ route('administrative.zone') }}">
