...
@section('content')
    <div class="mt-2">
        <ul class="dm-breadcrumb nav">
            ...
            <li class="dm-breadcrumb__item">
                <a href="#">Approve Date Wise Collection</a>
            </li>
        </ul>
    </div>
    <div class="d-flex mt-4 justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-2">Approve Date Wise Collection</h4>
        </div>
    ...
    <form method="post" action="{{ route('administrative.data.approve.date.wise.collection.download') }}">
        ...
        <div class="row">
            ...
            <div class="col-md-2 d-flex justify-content-end align-self-baseline">
                ...
                <button type="submit" class="btn btn-primary btn-icon-text btn-xs mb-2 mb-md-0">
