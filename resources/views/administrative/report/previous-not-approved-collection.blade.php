...
@section('content')
    <div class="mt-2">
        <ul class="dm-breadcrumb nav">
            ...
            <li class="dm-breadcrumb__item">
                <a href="#">Previous Not Approved</a>
            </li>
        </ul>
    </div>
    <div class="d-flex mt-4 mb-2 justify-content-between align-items-center flex-wrap grid-margin">
        <div>
            <h4 class="mb-3 mb-md-0">Previous Not Approved</h4>
        </div>
        <div class="d-flex align-items-center flex-wrap text-nowrap">
            <a href="{{ route('administrative.data.previous.not.approve.download') }}"
    ...
    <script>
        $(document).ready(function() {
            $('#datatables').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('administrative.data.previous.not.approve') }}",
                columns: [
