...
<div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
    <div>
        <h4 class="mb-3 mb-md-0"> Import Customer</h4>
    </div>
</div>
<div class="row">
    <div class="col-md-8 grid-margin stretch-card offset-md-2">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form class="forms-sample" action="{{route('store_customer')}} " method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="d-flex">
                        ...
                        <a href="{{asset('/csv/customer_import_example.csv')}}" class="btn btn-xs btn-primary btn-icon-text me-2 mb-md-0">
