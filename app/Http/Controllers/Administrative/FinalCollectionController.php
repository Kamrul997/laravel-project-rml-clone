...
use App\Exports\FinalCollectionExport;
...
class FinalCollectionController extends Controller
{
    public function index(Request $request)
    {
        return view('administrative.report.final-collection');
    }
    ...
    public function download()
    {
        ...
        return Excel::download(new FinalCollectionExport($results), $date_str . 'final_collection.xlsx');
    }
}
